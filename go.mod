...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudwatchlogs v1.64.1 // @grafana/aws-datasources
	github.com/aws/aws-sdk-go-v2/service/ec2 v1.294.1 // @grafana/aws-datasources
